...
public class SJF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle(".:. Planificación CPU-SJF");
        ...
        jLabel5.setText("PLANIFICACIÓN DE CPU - SHORT JOB FIRST");
                ...
                */
                ...
                for( int i = 0; i < U.length - 1 ; i++) {
                    ...
                    for( int j = i + 1 ; j < U.length; j++ ){
                        if ( Integer.parseInt(U[j]) < Integer.parseInt(U[i] )) {
                                String aux = U[i];
                                String aux2 = S[i];
                                String aux3 = P[i];
                                String aux4 = "Listo";
                ...
                for( int i = 1; i < U.length - 1 ; i++) {
                    ...
                    //for( int j = i ; j < P.length; j++ ){
                        if ( Integer.parseInt(U[i+1]) > Integer.parseInt(U[i] )) {
                                String aux = U[i];
                                String aux2 = S[i];
                                String aux3 = P[i];
                                String aux4 = "Listo";
